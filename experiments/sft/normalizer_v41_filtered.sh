#!/usr/bin/env bash
# v41: train on filtered data (90% change pairs vs 31% before). Aggressive LR sweep.
set -u
...
RECIPES=(
  "v41a 256 512 1e-4 3.0 4 2"
  "v41b 256 512 5e-5 5.0 4 2"
  "v41c 128 256 2e-4 3.0 4 2"
  "v41d 256 512 1e-4 5.0 2 4"
)
...
echo "=== v41 iterate end $(date -u +%FT%TZ) ==="

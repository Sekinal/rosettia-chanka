...
GSPO_TRAINER_EVAL="${GSPO_TRAINER_EVAL:-false}" \
GSPO_FINAL_METRICS_MAX_SAMPLES="${GSPO_FINAL_METRICS_MAX_SAMPLES:-16}" \
GSPO_FINAL_GENERATION_BATCH_SIZE="${GSPO_FINAL_GENERATION_BATCH_SIZE:-8}" \

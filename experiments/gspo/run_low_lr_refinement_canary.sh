...
CANARY_OUTPUT_DIR="${CANARY_OUTPUT_DIR:-outputs/gspo_paper_profiles/2511_low_lr_refine_current_best_${STAMP}}"
EVAL_DIR="${EVAL_DIR:-outputs/gspo_checkpoint_evals/${STAMP}-low-lr-refine-canary}"
...
env \
  ...
  LEARNING_RATE="${GSPO_LEARNING_RATE:-2e-7}" \
